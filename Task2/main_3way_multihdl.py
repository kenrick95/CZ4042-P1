...
for lr in learning_rate:
    for _hdl in hdl:
        ...
        print("----------- Model lr = %s, hdn = %s, hdl = %s " % (lr, hidden_nodes, _hdl))
        print("loss: %s" % (loss))


        f = open('training_3w_v2_pt50_%shdl_%shdn_lr%s.pkl' % (_hdl, hidden_nodes, lr), 'wb')
